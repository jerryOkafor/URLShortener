        ...
        <>
            <div className="flex items-center space-x-4 rtl:space-x-reverse">
                ...
                <div className="flex-1 min-w-0 space-y-2">
                    ...
                    <div
                        className="inline-flex flex-row space-x-3 justify-center text-sm text-gray-500 dark:text-gray-400">
                        Short Url:
                        <Link className="text-wrap border-r border-gray-400/50 pr-4"
                              href={shortLink.short_url} target="_blank">
                            {shortLink.short_url}
                        </Link>
                        <Tooltip content={copied ? "Copied" : "Copy"}>
                            <Button placeholder="" variant="text" className="p-1"
                                    onClick={() => {
                ...
                <div
                    className="inline-flex-l min-w-0 space-y-2 items-center">
                    <p>Status: Active</p>
