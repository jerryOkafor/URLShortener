...
import { createShortLink } from "@/app/api/actions/actions";
import { GlobeAltIcon } from "@heroicons/react/24/outline";
import React from "react";
import { ClipboardWithTooltip } from "@/app/components/tooltip";
...
export default function CreateShortLinkForm() {
  ...
  return (
    <div className="flex flex-col  justify-center items-center">
      ...
      <div className="inline-flex items-center text-1xl font-light text-center text-gray-900 dark:text-white ml-10 mr-10">
        UrlShortener is an efficient and easy-to-use URL shortening service that
